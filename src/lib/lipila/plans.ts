...
export const PLANS: PlanDefinition[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "5,000 answered website messages a month",
  ...
  },
  {
    ...
    voiceMinutesLabel: "500 voice call minutes/mo",
    whatsappNumbers: 10,
    brandingRemovable: true,
    channelsUnlocked: true,
    maxProperties: null,
  ...
  // --- Legacy. Hidden from pricing; honoured until the period ends. ---
  {
    ...
    voiceMinutesLabel: "30 voice call minutes/mo",
    whatsappNumbers: 1,
    brandingRemovable: true,
    channelsUnlocked: true,
    maxProperties: null,
  ...
  },
  {
    ...
    voiceMinutesLabel: "120 voice call minutes/mo",
    whatsappNumbers: 2,
    brandingRemovable: true,
    channelsUnlocked: true,
    maxProperties: null,
